...
public interface ObjectFactory
{
     ...
     */
    <T> T create(Class<T> type, Consumer<ContainerConfigurer> configurer);
     ...
     */
    <T> T create(String className, Class<T> superType, Consumer<ContainerConfigurer> configurer);

    default <T> T create(String className, Class<T> superType) {
        return create(className, superType, (configurer) -> {});
    }
}